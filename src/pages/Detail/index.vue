            ...
            <div class="chooseArea">
              ...
              <dl v-for="skuSaleAttr in skuSaleAttrList" :key="skuSaleAttr.id">
                ...
                <dd
                  ...
                  v-for="skuSaleAttrValue in skuSaleAttr.skuSaleAttrValueList"
                  :key="skuSaleAttrValue.id"
                  @click="
                    changeActive(
                      skuSaleAttrValue,
                      skuSaleAttr.skuSaleAttrValueList
                    )
                  "
                >
...
export default {
  ...
  methods: {
    changeActive(skuSaleAttrValue, arr) {
      arr.forEach((item) => {
        item.isChecked = "0";
      });
      skuSaleAttrValue.isChecked = "1";
    },
  },
};
</script>
